...
public class ErrorRecorderAdapter {
	...
	ArrayList<gov.nist.toolkit.errorrecordingold.client.SummaryToken> summary = new ArrayList<gov.nist.toolkit.errorrecordingold.client.SummaryToken>();
	ArrayList<gov.nist.toolkit.errorrecordingold.client.ValidationReportItem> detailed = new ArrayList<gov.nist.toolkit.errorrecordingold.client.ValidationReportItem>();
