...
Gateway system under test (RIG SUT), requesting a multiple image DICOM study 
residing on IDS F. The SOAP Body for this request may be viewed in the "Metadata".
<li/>The RIG SUT is expected to process the RAD-75 Request, generating a 
corresponding RAD-69 request to the Imaging Document Source F simulator
(IDS F sim).
<li/>The IDS F sim will process the RAD-69 request, generating a response
