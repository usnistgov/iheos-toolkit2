...
import gov.nist.toolkit.valregmetadata.newtop.MetadataValidator;
import gov.nist.toolkit.valregmetadata.newtop.ObjectStructureValidator;
import gov.nist.toolkit.valregmetadata.newtop.SubmissionStructure;
...
public class NewMetadataMessageValidator extends AbstractMessageValidator {
//	OMElement xml;
	Metadata m = null;
...
//	}
	...
	public NewMetadataMessageValidator(ValidationContext vc, MessageBody messageBody, ErrorRecorderBuilder erBuilder, MessageValidatorEngine mvc, RegistryValidationInterface rvi) {
		super(vc);
