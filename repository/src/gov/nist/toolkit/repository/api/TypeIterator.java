 ...
 * implements gov.nist.toolkit.repository.api.StringIterator, the class should be in the
...
public interface TypeIterator extends java.io.Serializable {
     ...
     * @return boolean
     *
     * @throws gov.nist.toolkit.repository.api.SharedException An exception with one of the
     *         following messages defined in gov.nist.toolkit.repository.api.SharedException
     *         may be thrown:  {@link
     *         gov.nist.toolkit.repository.api.SharedException#UNKNOWN_TYPE UNKNOWN_TYPE},
     *         {@link gov.nist.toolkit.repository.api.SharedException#PERMISSION_DENIED
     *         PERMISSION_DENIED}, {@link
     *         gov.nist.toolkit.repository.api.SharedException#CONFIGURATION_ERROR
