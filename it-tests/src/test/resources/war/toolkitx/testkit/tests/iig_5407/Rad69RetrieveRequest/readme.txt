...
Under Test (IIG SUT), requesting two DICOM object files, one of which is present
in the Image Document Source simulator. The SOAP Body for this request may be 
...
containing the image which was found and an error message regarding the other
image.
