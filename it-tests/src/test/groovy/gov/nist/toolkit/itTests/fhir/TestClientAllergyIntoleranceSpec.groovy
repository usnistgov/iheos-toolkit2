 ...
 *
 */
class TestClientAllergyIntoleranceSpec extends FhirSpecification {
    ...
    @Shared TestInstance testInstance = new TestInstance('FhirTestClientCreateAllergyIntolerance')
