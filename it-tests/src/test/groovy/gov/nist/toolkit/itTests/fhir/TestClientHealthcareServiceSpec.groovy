...
/**
 * Created by rmoult01 on 7/17/17.
 */
class TestClientHealthcareServiceSpec extends FhirSpecification {
    ...
    @Shared TestInstance testInstance = new TestInstance('FhirTestClientCreateHealthcareService')
