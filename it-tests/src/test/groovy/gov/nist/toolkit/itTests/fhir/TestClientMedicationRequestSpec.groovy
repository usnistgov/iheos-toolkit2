...
class TestClientMedicationRequestSpec extends FhirSpecification {
    ...
    @Shared TestInstance testInstance = new TestInstance('FhirTestClientCreateMedicationRequest')
