...
class TestClientMedicationStatementSpec extends FhirSpecification {
    ...
    @Shared TestInstance testInstance = new TestInstance('FhirTestClientCreateMedicationStatement')
