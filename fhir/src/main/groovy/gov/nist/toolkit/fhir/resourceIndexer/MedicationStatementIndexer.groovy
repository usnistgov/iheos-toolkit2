...
class MedicationStatementIndexer implements IResourceIndexer {
    ...
    ResourceIndex build(DomainResource theResource, String id) {
        ...
        MedicationStatement diagnosticReport = (MedicationStatement) theResource

        Reference subject = diagnosticReport.subject
        if (subject) addIndex(MedicationStatement.SP_SUBJECT, subject.reference)
