...
class ConditionResourceProvider implements IResourceProvider{
    @Override
    ...
    public MethodOutcome createCondition(@ResourceParam Condition theCondition,
        ...
        return new ToolkitResourceProvider(theCondition.class, requestDetails).createOperation(theCondition)
    }
    ...
    public List<Condition> getCondition(
        ...
        term = new Term(Condition.SP_PATIENT, thePatient.value)
    ...
    def validateResource(Condition theCondition) {}
}
