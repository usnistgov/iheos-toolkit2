...
class OrganizationResourceProvider implements IResourceProvider{
    ...
    public MethodOutcome createOrganization(@ResourceParam Organization theOrganization,
        ...
        return new ToolkitResourceProvider(getResourceType(), requestDetails).createOperation(theOrganization)
    }

    @Read()
    public Organization getResourceById(@IdParam IdType theId, RequestDetails requestDetails) {
    ...
    public List<Organization> getOrganization(
            @RequiredParam(name = Organization.SP_PARTOF) StringParam thePartOf,
            RequestDetails requestDetails) {
        ToolkitResourceProvider tk = new ToolkitResourceProvider(getResourceType(), requestDetails)
        ...
        term = new Term(Organization.SP_PARTOF, thePartOf.value)
    ...
    def validateResource(Organization theLocation) {}
}
