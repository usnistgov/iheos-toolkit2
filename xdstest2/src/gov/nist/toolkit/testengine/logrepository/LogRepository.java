 ...
 *
 */
abstract public class LogRepository {
	File logDir = null;
	String user; 

	abstract public LogRepository getNewLogRepository() throws IOException;  // must initialize logDir
	abstract protected Logger getLogger();
	
	protected LogRepository(String user) {
		this.user = user;
	}
