...
public class DrawHandlerGwt extends DrawHandler {
	...
	private void setLineDash(Context2d ctx, LineType lineType, double lineThickness) {
		try {
			...
			new Notification().showFeatureNotSupported("Dashed and dotted lines are shown as solid lines<br/>To correctly display them, please use Firefox or Chrome", true);
		}
	}
