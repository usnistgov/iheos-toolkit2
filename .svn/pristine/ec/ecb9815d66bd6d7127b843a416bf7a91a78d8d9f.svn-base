...
//		return new DashboardDaemon(warHome, outputDirStr).getDashboardDirectory();
	...
	RepositoryStatus loadRepositoryStatus(String filename) throws IOException, ClassNotFoundException {
	...
	RegistryStatus loadRegistryStatus(String filename) throws IOException, ClassNotFoundException {
		FileInputStream fis = null;
		ObjectInputStream in = null;
