...
/**
 * Simple Pair class to replace OpenSAML Pair for Java 8 compatibility
 */
class Pair<K, V> {
 ...
 * <li>the presenter's public cert matches an {@link org.opensaml.xmlsec.signature.X509Certificate} within one of the
    	            ...
    	            try {
    	                ...
    	                if ("DSA".equals(keyAlgo)) {
    	                    ...
    	                    for (KeyValue keyValue : keyValues) {
    	                        ...
    	                        if (dsaKeyValue != null && key.equals(KeyInfoHelper401.getDSAKey(dsaKeyValue))) {
    	                ...
    	                if ("RSA".equals(keyAlgo)) {
    	                    ...
    	                    for (KeyValue keyValue : keyValues) {
    	                        ...
    	                        if (rsaKeyValue != null && key.equals(KeyInfoHelper401.getRSAKey(rsaKeyValue))) {
    	                            System.out.println("Matched DSAKeyValue");
    	                            return true;
    	                        }
    	                    }
    	            ...
    	            for (X509Data data : x509Datas) {
    	                ...
    	                try {
    	                    for (org.opensaml.xmlsec.signature.X509Certificate xmlCertificate : xmlCertificates) {
    	                        if (cert.equals(KeyInfoHelper401.getCertificate(xmlCertificate))) {
