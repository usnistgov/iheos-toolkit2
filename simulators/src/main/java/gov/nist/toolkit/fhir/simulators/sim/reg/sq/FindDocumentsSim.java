...
public class FindDocumentsSim extends FindDocuments {
	...
	protected Metadata runImplementation() throws MetadataException,
		...
		runImplementationFilter();

		return buildReturnFormat();

	}

	protected void runImplementationFilter() throws MetadataException,
			XdsException, LoggerException {
		mc = ri.getMetadataCollection();
	...
	protected Metadata buildReturnFormat() throws MetadataException,
			XdsException, LoggerException {
