...
public class EstOrchestrationBuilder {
    ...
    public EstOrchestrationBuilder(ToolkitApi api, Session session, EsOrchestrationRequest request) {
        this.api = api;
