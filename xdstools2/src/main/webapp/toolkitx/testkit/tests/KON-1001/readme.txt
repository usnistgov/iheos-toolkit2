Key Object Note (KON) Validation
...
<li/>Build your test environment.
...
your IDS SUT to the Repository/Registry with the following characteristics:
<ul>
<li/>Blah...
<li/>Blah...
</ul>
...
from the Repository/Registry Simulator, evaluate it, and report the results.</p>
