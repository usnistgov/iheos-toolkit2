...
2) Attempt to remove the DocumentEntry and Association object. The refererence to the SubmissionSet object is not included in this request. Becuase the SubmissionSet no longer references any other metadata objects, the Document Registry should respond with the exception, XDSUnreferencedObjectException. 
