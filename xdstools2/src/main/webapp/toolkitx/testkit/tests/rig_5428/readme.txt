...
from a Initiating Imaging Gateway actor (Simulator) for a multiple image DICOM
study.
...
Document Sources, this test expects two images to be returned from a single 
