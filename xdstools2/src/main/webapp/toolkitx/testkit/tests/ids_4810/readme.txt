...
<p/>The Imaging Document Source has submitted a KOS for a study with a single image in test 4801.
...
<ul>
 <li>Successfully complete IDS Test 4801.</li>
 <li>Make sure the image data referenced in IDS Test 4801 is ready for retrieve using the RAD-69 transaction.</li>
