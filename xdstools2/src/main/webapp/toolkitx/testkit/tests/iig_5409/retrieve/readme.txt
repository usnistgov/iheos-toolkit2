...
Under Test (IIG SUT), requesting DICOM object files from both Responding Imaging
Gateways A and B. The SOAP Body for this request may be viewed in the "Metadata".
...
simulator.
<li/>The IDS simulators will process the RAD-69 requests, generating responses
