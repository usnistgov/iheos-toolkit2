...
<h2>Imaging Document Consumer RAD-69 Retrieve Imaging Document Set: Single Image 
Study</h2>
<h3>Purpose / Context</h3>
The Imaging Document Consumer performs:<ul>
<li/>RAD-69 Retrieve Imaging Document Set to retrieve the study for the specified image.
</ul>
...
IDCAD013-a^^^&1.3.6.1.4.1.21367.2005.13.20.1000&ISO
...
from the Imaging Document Source simulator.
</ol>
<i>Validation</i>
<ol>
<li/>Test Manager: Detailed instructions on validating the query and retrieve of 
the KOS are outlined in the test: 'Imaging Document Consumer Retrieve KOS: 
Single Image Study'. Follow verification steps 1 through 6.
...
<li/>Test Manager: Locate the RAD-69 request message in the proxy.<ol type="a">
<li/>Browse to http://gazelle-proxy-host:8180/proxy
...
labeled with the white arrow in the green circle.</ol>
...
<ol type="a"><li/>StudyRequest
<ol type="i"><li/>SeriesRequest
<ol><li/>DocumentRequest</ol></ol>
<li/>TransferSyntaxUIDList
<ol type="i"><li/>TransferSyntaxUID</ol></ol></ol>
