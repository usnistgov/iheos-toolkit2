...
<li>$XDSDocumentEntryType = Stable</li>
...
<b>Evaluation</b>
The System successfully processes the Request and returns a Response to the Testing Tool that contains the following objects one Stable document entry with:
<ul>
<li>A 'DocumentMatch' of: XDSDocumentEntry.uniqueId = D-00000002.1 OR (XDSDocumentEntry.patientID = [P-00000002 PID] AND XDSDocumentEntry.authorPerson = [value from D-00000002.1])</li>
