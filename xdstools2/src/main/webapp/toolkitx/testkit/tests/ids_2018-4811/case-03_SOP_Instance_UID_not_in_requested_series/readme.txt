<h3>Send RAD-69 Request to IDS SUT - SOP Instance UID not in requested series.</h3>
...
a different series in the same study.
...
DICOM image file that exists in the test data, but is in a sequence other than
