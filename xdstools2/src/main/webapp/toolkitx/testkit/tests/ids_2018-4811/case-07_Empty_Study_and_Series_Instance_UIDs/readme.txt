<h3>Send RAD-69 Request to IDS SUT - Empty Study and Series Instance UID</h3>

<p/>This section tests the ability of the IDS SUT to respond correctly to a
Retrieve Imaging Document Set (RAD-69) Request where the SOP Instance UID is 
known, and the Study and Series Instance UIDs are included, but are blank.
...
Under Test (IDS SUT). This Request will reference a SOP Instance UID for a DICOM 
image file that exists in the test data, the Study and Series Instance UIDs will 
be blank.
