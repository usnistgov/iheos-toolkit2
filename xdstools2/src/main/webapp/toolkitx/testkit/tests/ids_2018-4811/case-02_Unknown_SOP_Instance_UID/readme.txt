<h3>Send RAD-69 Request to IDS SUT - Unknown SOP Instance UID.</h3>
...
Series Instance UID are known, but the SOP Instance UID does not reference a 
known object.
...
Under Test (IDS SUT). This Request will reference an unknown SOP Instance UID. 
