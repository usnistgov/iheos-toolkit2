...
Gateway system under test (RIG SUT), requesting two DICOM object files, one of 
which is present in the Image Document Source simulator. The SOAP Body for this 
