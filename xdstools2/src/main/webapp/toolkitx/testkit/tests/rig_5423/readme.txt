...
from a Initiating Imaging Gateway actor (Simulator), ), for a single DICOM 
image file with two acceptable Transfer Syntaxes:<ol>
<li/>1.2.840.10008.1.2.4.50: JPEG Baseline (Process 1)
<li/>1.2.840.10008.1.2.4.70 - JPEG lossless.</ol>
