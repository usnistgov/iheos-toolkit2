...
imaging study with one image using two transfer syntax values.</p>
<table border="1">
 ...
 <tr><td>Transfer Syntax UID</td>
  <td>1.2.840.10008.1.2.4.50: JPEG Baseline (Process 1) <br/>1.2.840.10008.1.2.4.70: JPEG lossless </td></tr>
</table>
