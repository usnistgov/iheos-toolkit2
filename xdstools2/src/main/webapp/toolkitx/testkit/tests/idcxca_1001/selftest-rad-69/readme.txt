<h3>Send Retrieve Image Document Set (RAD-69) Request to IIG SUT Self Test.</h3>
...
Under Test (IIG SUT), requesting a single DICOM object file. The SOAP Body for
this request may be viewed in the "Metadata".
<li/>The IIG SUT is expected to process the request and generate a Cross Gateway
