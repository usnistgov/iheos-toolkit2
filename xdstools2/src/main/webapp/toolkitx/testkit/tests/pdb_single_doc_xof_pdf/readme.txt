...
<li><b>submit</b> - send a Provide Document Bundle transaction with a single Document Reference (a PDF)
...
requested mime type is application/pdf so the PDF content without the Binary resource wrapper is expected back.
