<h3>Send RAD-55 Request to IDS SUT - Unknown SOP Instance UID.</h3>

<p/>This section tests the ability of the IDS SUT to correctly respond to a
RAD-55 WADO Request which contains valid Study and Series Instance UIDs, and an
...
Under Test (IDS SUT), containing valid Study and Series Instance UIDs, and an
invalid SOP Instance UID.
