<h3>Send RAD-55 Request to IDS SUT - empty study and series Instance UID.</h3>

<p/>This section tests the ability of the IDS SUT to correctly respond to a
RAD-55 WADO Request which contains an empty study and series UID.
...
Under Test (IDS SUT), containing empty study and series UIDs.
