<h3>Send RAD-55 Request to IDS SUT - SOP Instance from wrong study.</h3>
...
SOP Instance UID which represents an image which is in the indicated series, but 
not in the indicated study.
...
SOP Instance UID from a different study.
