<h3>Send Retrieve Image Document Set (RAD-69) Request with HomeCommunityID to 
IDS SUT.</h3>
...
Under Test (IDS SUT). This message will contain a HomeCommunityID Element and
value in the DocumentRequest.
<li/>The IDS SUT is expected to process the test and generate a response
containing the requested image, and returning the HomeCommunityId Element and
