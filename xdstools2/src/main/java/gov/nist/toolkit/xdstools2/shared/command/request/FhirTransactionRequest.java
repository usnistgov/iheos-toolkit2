 ...
 *
 */
public class FhirTransactionRequest extends CommandContext {
    private SiteSpec site;
    private DatasetElement datasetElement;

    public FhirTransactionRequest() {
    }

    public FhirTransactionRequest(CommandContext context, SiteSpec site, DatasetElement datasetElement) {
        copyFrom(context);
        this.site = site;
