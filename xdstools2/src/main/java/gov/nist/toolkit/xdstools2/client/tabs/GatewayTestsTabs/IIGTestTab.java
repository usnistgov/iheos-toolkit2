...
//            .create(ToolkitService.class);
    ...
    static final TestCollectionCode COLLECTION_NAME =  new TestCollectionCode("iigtool");
            ...
            public void onClick(ClickEvent clickEvent) {
                ...
                new GetTestResultsCommand(){
                    ...
                    public void onComplete(Map<String, Result> stringResultMap) {
                        ...
                        SiteSpec siteSpec = new SiteSpec(siteName, ActorType.RESPONDING_GATEWAY, null, ClientUtils.INSTANCE.getCurrentTestSession());
