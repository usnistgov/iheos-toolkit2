...
public class BuildESTestOrchestrationButton extends AbstractOrchestrationButton {
    ...
    private ESTestTab testTab;

    BuildESTestOrchestrationButton(ESTestTab testTab, Panel topPanel, String label) {
    ...
    public void orchestrate() {
        ...
        new BuildEsTestOrchestrationCommand(){
            ...
            public void onComplete(RawResponse rawResponse) {
                if (handleError(rawResponse, EsOrchestrationResponse.class)) return;
