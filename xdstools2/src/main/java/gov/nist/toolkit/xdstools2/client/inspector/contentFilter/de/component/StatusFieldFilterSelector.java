...
public class StatusFieldFilterSelector extends IndexFieldFilterSelector<DocumentEntryIndexField, DocumentEntry> {
    ...
    public StatusFieldFilterSelector(String label, SimpleCallbackT<NewSelectedFieldValue> valueChangeNotification) {
        ...
        approvedCountLabel.addStyleName("uiSpacerMarginLeft");
        ...
        deprecatedCountLabel.addStyleName("uiSpacerMarginLeft");
        fp.add(deprecatedCountLabel);
        unknownRb.setVisible(false);
        unknownCountLabel.addStyleName("inlineBlock");
        unknownCountLabel.addStyleName("uiSpacerMarginLeft");
