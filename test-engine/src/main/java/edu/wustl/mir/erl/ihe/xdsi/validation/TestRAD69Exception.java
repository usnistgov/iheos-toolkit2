 ...
 */
public class TestRAD69Exception extends Test {
...
//		String subLabel  = (String)args[5];
		...
		for (int testIndex = 101; testIndex <= 109; testIndex++) {
...
//		addStep(step);
   ...
   public static void main(String[] args) {
      log = Utility.getLog();
      TestRAD69Exception testRAD69Exception = new TestRAD69Exception();
      try {
    	  testRAD69Exception.initializeTest(args);
    	  testRAD69Exception.runTest();
    	  testRAD69Exception.reportResults("RAD 69 Exceptions");
