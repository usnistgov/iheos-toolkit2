...
/**
 * Helper class for xml namespace contexts 
 */
public class XDSINamespaceContext implements Serializable, NamespaceContext {
    ...
    */
   public XDSINamespaceContext(QName[] namespaces) {
