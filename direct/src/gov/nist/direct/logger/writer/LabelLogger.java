...
public class LabelLogger {
	...
	// Logging a label
	public void logLabel(String label, String transactionType, String messageType, String username, String messageId) throws IOException {
		String labelLogPath = ls.getLabelLogPath(transactionType, messageType, username, messageId);
		Utils.writeToFile(label, labelLogPath);
		}
