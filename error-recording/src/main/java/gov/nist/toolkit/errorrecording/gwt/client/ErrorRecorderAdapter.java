...
public class ErrorRecorderAdapter {
	...
	ArrayList<gov.nist.toolkit.errorrecording.gwt.client.SummaryToken> summary = new ArrayList<gov.nist.toolkit.errorrecording.gwt.client.SummaryToken>();
	ArrayList<gov.nist.toolkit.errorrecording.gwt.client.ValidationReportItem> detailed = new ArrayList<gov.nist.toolkit.errorrecording.gwt.client.ValidationReportItem>();
