...
Gateway system under test (RIG SUT), requesting two DICOM object files from 
different studies, both residing on IDS E. The 
SOAP Body for this request may be viewed in the "Metadata".
