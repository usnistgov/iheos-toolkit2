...
public class SubmissionSetOld extends AbstractRegistryObject implements TopLevelObject {
	...
	public SubmissionSetOld(Metadata m, OMElement ro) throws XdsInternalException  {
		super(m, ro);
	}

	public SubmissionSetOld(String id) {
		super(id);
