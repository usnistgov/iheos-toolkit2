...
public enum TransactionType implements Serializable, IsSerializable {
    ...
    XDR_PROVIDE_AND_REGISTER("ITI-41", "XDR Provide and Register", "xdrpr", "xdrpr", "xdrpr.as", false, "urn:ihe:iti:2007:ProvideAndRegisterDocumentSet-b", "urn:ihe:iti:2007:ProvideAndRegisterDocumentSet-bResponse", true, "XDR"+ SimulatorProperties.pnrEndpoint, "XDR"+ SimulatorProperties.pnrTlsEndpoint),
    ...
    ODDS_RETRIEVE("ITI-43", "On-Demand Document Source Retrieve", "ret", "ret.b", "ret.as", true, "urn:ihe:iti:2007:RetrieveDocumentSet", "urn:ihe:iti:2007:RetrieveDocumentSetResponse", true, "ODDS"+SimulatorProperties.retrieveEndpoint, "ODDS"+SimulatorProperties.retrieveTlsEndpoint),
    ISR_RETRIEVE("ITI-43", "Integrated Source/Repository Retrieve", "isr", "isr", "isr.as", false, "urn:ihe:iti:2007:RetrieveDocumentSet", "urn:ihe:iti:2007:RetrieveDocumentSetResponse", true, "ISR"+SimulatorProperties.retrieveEndpoint, "ISR"+SimulatorProperties.retrieveTlsEndpoint),
    ...
    XCPD("ITI-55", "XCPD Query", "xcpd", "xcpd", "xcpd.as", false, "urn:hl7-org:v3:PRPA_IN201305UV02:CrossGatewayPatientDiscovery", "urn:hl7-org:v3:PRPA_IN201305UV02:CrossGatewayPatientDiscoveryResponse", false, "XCPD", "tlsXCPD"),
    ...
    MPQ("ITI-51", "Multi-Patient Query", "mpq", "mpq", "mpq.as", false, "urn:ihe:iti:2009:MultiPatientStoredQuery", "urn:ihe:iti:2009:MultiPatientStoredQueryResponse", false, "MPQ", "tlsMPQ"),
    XC_PATIENT_DISCOVERY("ITI-55", "Cross Community Patient Discovery", "xcpd", "xcpd", "xcpd.as", false, "urn:hl7-org:v3:PRPA_IN201305UV02:CrossGatewayPatientDiscovery", "urn:hl7-org:v3:PRPA_IN201306UV02:CrossGatewayPatientDiscovery", false, "XC_PATIENT_DISCOVERY", "tlsXC_PATIENT_DISCOVERY"),
//    DIRECT("ONC-DIRECT", "ONC-DIRECT", "direct", "direct", "direct.as", false, "", "", false, null, null),
    PIF("PIF", "Patient Identity Feed", "pif", "pif", "pif", false, "", "", false, "PIF", "tlsPIF"),
    ...
    STS("STS", "Secure Token Service", "sts", "sts", "sts.as", true, "sts", "sts", true, "STS", "tlsSTS"),
//    FHIR("FHIR", "FHIR", "fhir", "fhir", "fhir.as", true, "fhir", "fhir", true, SimulatorProperties.fhirEndpoint, SimulatorProperties.fhirTlsEndpoint, true),
    XAD_PID("ITI-43", "XAD-PID", "xadpid", "xadpid", "xadpid", false, "", "", false, "XADPID", "tlsXADPID"),
